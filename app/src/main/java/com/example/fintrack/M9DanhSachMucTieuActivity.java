...
public class M9DanhSachMucTieuActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        androidx.appcompat.widget.Toolbar toolbar = findViewById(R.id.toolbar_m9_muctieu);
    ...
    /**
     * Lắng nghe real-time toàn bộ collection MucTieuTietKiem.
     * Tạm thời bỏ orderBy để tránh lỗi thiếu Index trên Firestore gây ra việc không hiển thị dữ liệu.
     */
    private void dangKyLangNgheDuLieu() {
        // Sử dụng query cơ bản nhất để kiểm tra dữ liệu
        Query query = mucTieuRef;
